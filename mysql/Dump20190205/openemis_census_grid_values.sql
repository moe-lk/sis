...
--
-- Table structure for table `census_grid_values`
--
...
--
-- Dumping data for table `census_grid_values`
--

LOCK TABLES `census_grid_values` WRITE;
/*!40000 ALTER TABLE `census_grid_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_grid_values` ENABLE KEYS */;
UNLOCK TABLES;
