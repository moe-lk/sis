...
--
-- Table structure for table `census_buildings`
--
...
--
-- Dumping data for table `census_buildings`
--

LOCK TABLES `census_buildings` WRITE;
/*!40000 ALTER TABLE `census_buildings` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_buildings` ENABLE KEYS */;
UNLOCK TABLES;
