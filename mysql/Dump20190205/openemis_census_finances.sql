...
--
-- Table structure for table `census_finances`
--
...
--
-- Dumping data for table `census_finances`
--

LOCK TABLES `census_finances` WRITE;
/*!40000 ALTER TABLE `census_finances` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_finances` ENABLE KEYS */;
UNLOCK TABLES;
