...
--
-- Table structure for table `census_rooms`
--
...
--
-- Dumping data for table `census_rooms`
--

LOCK TABLES `census_rooms` WRITE;
/*!40000 ALTER TABLE `census_rooms` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_rooms` ENABLE KEYS */;
UNLOCK TABLES;
