...
--
-- Dumping data for table `examination_item_results`
--

LOCK TABLES `examination_item_results` WRITE;
/*!40000 ALTER TABLE `examination_item_results` DISABLE KEYS */;
/*!40000 ALTER TABLE `examination_item_results` ENABLE KEYS */;
UNLOCK TABLES;
