...
--
-- Table structure for table `census_teachers`
--
...
--
-- Dumping data for table `census_teachers`
--

LOCK TABLES `census_teachers` WRITE;
/*!40000 ALTER TABLE `census_teachers` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_teachers` ENABLE KEYS */;
UNLOCK TABLES;
