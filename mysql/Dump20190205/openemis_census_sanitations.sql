...
--
-- Table structure for table `census_sanitations`
--
...
--
-- Dumping data for table `census_sanitations`
--

LOCK TABLES `census_sanitations` WRITE;
/*!40000 ALTER TABLE `census_sanitations` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_sanitations` ENABLE KEYS */;
UNLOCK TABLES;
