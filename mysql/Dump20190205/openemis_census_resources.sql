...
--
-- Table structure for table `census_resources`
--
...
--
-- Dumping data for table `census_resources`
--

LOCK TABLES `census_resources` WRITE;
/*!40000 ALTER TABLE `census_resources` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_resources` ENABLE KEYS */;
UNLOCK TABLES;
