...
CREATE TABLE `user_languages` (
  ...
  `language_id` int(11) NOT NULL COMMENT 'links to languages.id',
  `listening` int(1) DEFAULT NULL,
  `speaking` int(1) DEFAULT NULL,
  `reading` int(1) DEFAULT NULL,
  `writing` int(1) DEFAULT NULL,
