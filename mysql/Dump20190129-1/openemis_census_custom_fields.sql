...
--
-- Table structure for table `census_custom_fields`
--
...
--
-- Dumping data for table `census_custom_fields`
--

LOCK TABLES `census_custom_fields` WRITE;
/*!40000 ALTER TABLE `census_custom_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_custom_fields` ENABLE KEYS */;
UNLOCK TABLES;
