...
--
-- Table structure for table `census_teacher_fte`
--
...
--
-- Dumping data for table `census_teacher_fte`
--

LOCK TABLES `census_teacher_fte` WRITE;
/*!40000 ALTER TABLE `census_teacher_fte` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_teacher_fte` ENABLE KEYS */;
UNLOCK TABLES;
