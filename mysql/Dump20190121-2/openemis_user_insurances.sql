...
CREATE TABLE `user_insurances` (
  ...
  `insurance_provider_id` int(11) NOT NULL COMMENT 'links to insurance_providers.id',
  `insurance_type_id` int(11) NOT NULL COMMENT 'links to insurance_types.id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This table contains list of user insurance';
