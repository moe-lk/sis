...
--
-- Table structure for table `institution_site_section_classes`
--
...
--
-- Dumping data for table `institution_site_section_classes`
--

LOCK TABLES `institution_site_section_classes` WRITE;
/*!40000 ALTER TABLE `institution_site_section_classes` DISABLE KEYS */;
/*!40000 ALTER TABLE `institution_site_section_classes` ENABLE KEYS */;
UNLOCK TABLES;
