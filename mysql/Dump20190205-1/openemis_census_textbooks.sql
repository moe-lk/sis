...
--
-- Table structure for table `census_textbooks`
--
...
--
-- Dumping data for table `census_textbooks`
--

LOCK TABLES `census_textbooks` WRITE;
/*!40000 ALTER TABLE `census_textbooks` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_textbooks` ENABLE KEYS */;
UNLOCK TABLES;
