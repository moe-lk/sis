...
--
-- Table structure for table `census_furniture`
--
...
--
-- Dumping data for table `census_furniture`
--

LOCK TABLES `census_furniture` WRITE;
/*!40000 ALTER TABLE `census_furniture` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_furniture` ENABLE KEYS */;
UNLOCK TABLES;
