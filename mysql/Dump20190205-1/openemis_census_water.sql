...
--
-- Table structure for table `census_water`
--
...
--
-- Dumping data for table `census_water`
--

LOCK TABLES `census_water` WRITE;
/*!40000 ALTER TABLE `census_water` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_water` ENABLE KEYS */;
UNLOCK TABLES;
