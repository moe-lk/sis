...
--
-- Table structure for table `census_energy`
--
...
--
-- Dumping data for table `census_energy`
--

LOCK TABLES `census_energy` WRITE;
/*!40000 ALTER TABLE `census_energy` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_energy` ENABLE KEYS */;
UNLOCK TABLES;
