...
--
-- Table structure for table `census_behaviours`
--
...
--
-- Dumping data for table `census_behaviours`
--

LOCK TABLES `census_behaviours` WRITE;
/*!40000 ALTER TABLE `census_behaviours` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_behaviours` ENABLE KEYS */;
UNLOCK TABLES;
