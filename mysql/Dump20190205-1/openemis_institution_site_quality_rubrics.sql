...
--
-- Table structure for table `institution_site_quality_rubrics`
--
...
--
-- Dumping data for table `institution_site_quality_rubrics`
--

LOCK TABLES `institution_site_quality_rubrics` WRITE;
/*!40000 ALTER TABLE `institution_site_quality_rubrics` DISABLE KEYS */;
/*!40000 ALTER TABLE `institution_site_quality_rubrics` ENABLE KEYS */;
UNLOCK TABLES;
