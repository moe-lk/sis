...
--
-- Table structure for table `census_grids`
--
...
--
-- Dumping data for table `census_grids`
--

LOCK TABLES `census_grids` WRITE;
/*!40000 ALTER TABLE `census_grids` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_grids` ENABLE KEYS */;
UNLOCK TABLES;
