...
--
-- Table structure for table `census_graduates`
--
...
--
-- Dumping data for table `census_graduates`
--

LOCK TABLES `census_graduates` WRITE;
/*!40000 ALTER TABLE `census_graduates` DISABLE KEYS */;
/*!40000 ALTER TABLE `census_graduates` ENABLE KEYS */;
UNLOCK TABLES;
