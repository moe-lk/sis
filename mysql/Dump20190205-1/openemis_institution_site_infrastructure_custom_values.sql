...
CREATE TABLE `institution_site_infrastructure_custom_values` (
  ...
  PRIMARY KEY (`infrastructure_custom_field_id`,`institution_site_infrastructure_id`,`value_number`),
...
--
-- Dumping data for table `institution_site_infrastructure_custom_values`
--

LOCK TABLES `institution_site_infrastructure_custom_values` WRITE;
/*!40000 ALTER TABLE `institution_site_infrastructure_custom_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `institution_site_infrastructure_custom_values` ENABLE KEYS */;
UNLOCK TABLES;
