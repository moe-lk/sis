...
--
-- Table structure for table `z_4535_institution_repeater_survey_table_cells`
--

DROP TABLE IF EXISTS `z_4535_institution_repeater_survey_table_cells`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `z_4535_institution_repeater_survey_table_cells` (
  `id` char(36) NOT NULL,
...
--
-- Dumping data for table `z_4535_institution_repeater_survey_table_cells`
--

LOCK TABLES `z_4535_institution_repeater_survey_table_cells` WRITE;
/*!40000 ALTER TABLE `z_4535_institution_repeater_survey_table_cells` DISABLE KEYS */;
/*!40000 ALTER TABLE `z_4535_institution_repeater_survey_table_cells` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-01-17 15:12:27
